...
assert re.fullmatch(r"http://(?:\d{1,3}\.){3}\d{1,3}:3000", base_url)
assert "127.0.0.1" not in base_url and "localhost" not in base_url.lower()
...
print(f"PASS: firmware backend URL={base_url}")
